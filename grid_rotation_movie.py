...
theta_list = np.arange(0, 360, 0.5)*u.degree.to(u.radian) # <-- will go up to 359.5 degrees and loop. 
...
if __name__=="__main__":
    ...
    for ii, orbit in tqdm(enumerate(orbits)):
        ...
        core, data_dict, CMdict, lumdict, inMW, trim = prepare_nbody_data(
            ...
            i=loading_time if orbit !="circ" else int(30000), #age if orbit != "circ" else 30000,
